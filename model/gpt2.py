...
class GPTConfig:
    ...
    # GPT2 vocab_size of 50257, padded up to nearest multiple of 64 for efficiency
...
class GPT2(nn.Module):
    def __init__(self, config):
        ...
        # apply special scaled init to the residual projections, per GPT2-2 paper
    ...
    def from_pretrained(cls, model_type, override_args=None):
        ...
        config_args["block_size"] = 1024  # always 1024 for GPT2 model checkpoints
